...
<center>
  <div className="flex justify-center">
    <div className='flex flex-col'>
      <img
        alt="Standrd Navbar"
        src="https://github.com/maheshj01/navbar_router/assets/31410839/62d6154f-dcf5-4aa9-a819-e2c84caebad1"
        width="300"
      />
    ...
    <div className='flex flex-col'>
      <img
        alt="Notched Navbar"
        src="https://github.com/maheshj01/navbar_router/assets/31410839/5378f9cd-a6ac-4c6b-bd2a-a706e87b89eb"
        width="300"
      />
   ...
   <div className="flex justify-center">
    <div className='flex flex-col'>
      <img
        ...
        src="https://github.com/maheshj01/navbar_router/assets/31410839/027adf4f-d527-4dc5-ac22-8fe321734977"
        width="300"
      />
      ...
      <div className='flex flex-col'>
        <img
          alt="Floating Navbar"
          src="https://github.com/maheshj01/navbar_router/assets/31410839/b735a016-703a-4fc9-be4a-a8e924a7c645"
          width="300"
        />
