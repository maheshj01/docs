...
- Migrate WillPopScope to PopScope [Issue 48](https://github.com/maheshj01/navbar_router/pull/48/)
- Fix Deprecation [Issue 49](https://github.com/maheshj01/navbar_router/pull/49/)
- Migrate example app to Flutter's Gradle plugins
- Fix: Navbar Destination not updating on backbutton press [Issue 51](https://github.com/maheshj01/navbar_router/pull/51/)
- docs: Navbar Router should be wrapped in builder for Snackbar to work

#### [0.7.4] April 30, 2024

- Adds Support for Navbarbadges #[PR 43](https://github.com/maheshj01/navbar_router/pull/43/)
- Expose NavigationRail properties to NavbarRouter Part of [Issue #41](https://github.com/maheshj01/navbar_router/issues/41)
- Improve closing and opening of NavigationRail on Window resize/programmatically
- Propagate NavbarItem updates to Navbar [Issue #38](https://github.com/maheshj01/navbar_router/issues/38)
...
- Rebuild Navbar on updating its properties Fixes: [Issue #38](https://github.com/maheshj01/navbar_router/issues/38)
- Remove workaround for [Issue #17](https://github.com/maheshj01/navbar_router/issues/17)
- Add child parameter to NavbarItem for adding custom widgets in place of icon and label Fix [Issue #20](ttps://github.com/maheshj01/navbar_router/issues/20)
- Add selectedIcon property to NavbarItem

#### [0.7.0] Dec 08, 2023

- Fixes: [Issue #6](https://github.com/maheshj01/navbar_router/issues/6) Fade Transition is not smooth
...
- Fix: NavigationBar height is too much [Issue #17](https://github.com/maheshj01/navbar_router/issues/17)
...
- Fix: Notched Navbar Shape [Issue 19](https://github.com/maheshj01/navbar_router/issues/19)
...
- [WIP Ref:#8](https://github.com/maheshj01/navbar_router/issues/8) Adds support for custom Navbar using `NavbarRouter.type: NavbarType.notched`
...
- Remember stack history on back button press [Issue 9](https://github.com/maheshj01/navbar_router/issues/9)
