...
> If you are a Indie App Developer or a Company using navbar_router and want to showcase your Beautiful App, Please drop your app details in this [issue thread](https://github.com/maheshj01/navbar_router/issues/34). We would love to add your App to the Showcase.
