...
Pub : [navbar_router 0.7.0](https://pub.dev/packages/navbar_router)
...
- Smoothly Fade between NavbarDestinations
- Programmatically control state of bottom navbar from any part of widget tree e.g change index, hide/show bottom navbar, push/pop routes of any tab in the background and more.
