...
Pub : <NavLink
  text="navbar_router 0.7.5"
  isNewTab={true}
  className="text-lg"
  to="https://pub.dev/packages/navbar_router"
/>

<center>
  ![Floating
  Navbar](https://github.com/maheshj01/navbar_router/assets/31410839/7da504ae-4894-481c-a443-01a24fc61946)
</center>
...
checkout the <NavLink
  text="demo app here"
  isNewTab={true}
  className="text"
  to="https://navbar-router.netlify.app/"
/>
...
> Heres the same [sample app](https://gist.github.com/maheshj01/894922ccb67f5fdc4ffb652e41916fa2) without the package which requires around 800 lines of code.
