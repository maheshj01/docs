...
### Enough Git to get your job done in tech

I have often come across questions from folks when they run into a problem such as, I accidentally deleted a file, pushed a secret to Github, merged a wrong branch, deleted a local branch, and tonnes of questions, and I have experienced these situations myself day in and day out. I always wanted to write a comprehensive guide that acts as a knowledge base that I can refer to at any point in my career. I hope this is that blog post that will end all your git questions and help you git away with any git-related problems. This will be the longest blog post, I have ever written so probably you might want to read it in parts. So I am making it a 7-day Git tutorial.
...
Let me give simple instances of why you would need it, Imagine you are working on a project and

- Your hard disk crashes (pretty common if you keep hacking on your machine)
...
this tutorial aims to solve all these misconceptions and create a comprehensive guide to using git. I hope this has convinced you, why you need git and we can get down to the next steps.
